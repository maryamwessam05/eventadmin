...
const EditModal = (props) => {
    ...
    useEffect(() => {
        if (props.data) {
            ...
            if (props.data.event_categories) {
                const existingIds = props.data.event_categories.map(ec => ec.category_id);
    ...
    const handleSubmit = async () => {
        ...
        if (props.type === "event") {
            ...
            // Delete old categories then re-insert updated ones
            await supabase.from("event_categories").delete().eq("event_id", props.data?.event_id);
